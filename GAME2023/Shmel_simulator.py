...
#Hive
hive = GameSprite2('images/Hive.png',1100,50)
...
def play():
    ...
    while True:
        ...
        if (sprite.collide_rect(shmel_original, flower4) or sprite.collide_rect(shmel_original, flower8)) and hit_True:
            if health>1:
                health-=1
            else:
                proigrish=True    
